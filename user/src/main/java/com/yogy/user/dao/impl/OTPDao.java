...
import com.yogy.user.dao.interfaces.OTPRepository;
...
public class OTPDao implements OTPRepository {
	...
	@Override
	public <S extends OTP> S save(S s) {
		s.setCreationTime(System.currentTimeMillis());
		return mongoTemplate.save(s);
	}

	@Override
	public <S extends com.yogy.user.entity.OTP> List<S> saveAll(Iterable<S> iterable) {
		return null;
	}
